...
| **RG (Registro Geral)** | Per-state SSP/IGP | Full table: [§ RG](#rg--reference-index) | **UF required** — no federal algorithm. **14/27 UFs:** SP, RJ, MG, PR, RS, SC, BA, AC, AL, AM, AP, DF, ES, GO. SP/RJ/MG: Ghiorzi DV tables; PR/RS/BA/AC/AL/AM/AP/DF/ES/GO: format-only; SC: format-only + mask. Vectors: `rg.{sp,rj,mg,pr,rs,sc,ba,ac,al,am,ap,df,es,go}.official.json`. |
