...
| `getRgUfSupport` | `() => readonly RgUfCode[]` | Implemented states (8/27: SP, RJ, MG, PR, RS, SC, BA, AC) |
| `getRgPendingUfs` | `() => readonly UfCode[]` | 19 UFs awaiting community implementation |
