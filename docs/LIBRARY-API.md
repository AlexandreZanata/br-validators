...
> **TypeDoc signatures:** [docs.br-validators.dev/api-reference](https://docs.br-validators.dev/api-reference/) — auto-generated by `pnpm docs:api`; this file remains the narrative contract.
...
Golden: IBGE **`3550308`** (São Paulo), **`3304557`** (Rio de Janeiro), **`3106200`** (Belo Horizonte), **`3509502`** (Campinas — high-PIB non-capital, `estimativa: true`). Vector: `iss-municipal.official.json`.
